...
<form method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="text" name="published_date" id="published_date" value="<?= $book->getPublishedDate() ?>" class="form-control"/>
  </div>

  <div class="form-group">
    <label for="description">Description</label>
    <textarea name="description" id="description" class="form-control"><?= $book->getDescription() ?></textarea>
  </div>
...
<?php /* [START book_form_image] */ ?>
  ...
  <div class="form-group hidden">
    ...
    <input type="text" name="image_url" id="image_url" value="<?= $book->getImageUrl() ?>" class="form-control"/>
  </div>
